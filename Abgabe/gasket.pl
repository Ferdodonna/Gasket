...
test :-
	gasket_math:initiale_kreise(100,100,100,K1,K2,K3)
	, gasket_math:touchpoint(K1,K2,TP12)
	, gasket_math:touchpoint(K1,K3,TP13)
	, gasket_math:touchpoint(K2,K3,TP23)
	, umschreibender_kreis(K1,K2,K3,KU)
	, gasket_math:circle_from_three_points(TP12,TP13,TP23,K4)
	, gasket_math:spiegele_kreis(KU,K4,K5)
	, gasket_svg:fast_svg([KU,K1,K2,K3,K5],'hannes.svg')
.
