...
This project implements a script in Prolog that spits out [Apollian Gaskets](https://en.wikipedia.org/wiki/Apollonian_gasket). There are two ways to use it, both require you to install [SWI Prolog](https://www.swi-prolog.org).
